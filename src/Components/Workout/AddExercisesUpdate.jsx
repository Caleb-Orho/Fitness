...
const AddExercisesUpdate = ({ setShowAddExercise, setSelectedExercisesSend, replaceExerciseIndex, setReplaceExerciseIndex, setRoutine }) => {
    ...
    const handleAdd = () => {
        ...
        if (replaceExerciseIndex == -2) {
            setRoutine(prevRoutine => ({
                ...prevRoutine,
                ['ca']: [...prevRoutine['ca'], selectedExerciseDetails],
            }));
            return
        }
...
export default AddExercisesUpdate
